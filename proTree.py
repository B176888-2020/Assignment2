...
def protree(proFamily, taxGroup, spOrId, proSelection, vbo):
    ...
    if vbo:
        pepReply = input(
            "Do you want to get the protein property information of collected sequences generated by pepstats method? \n" +
            "Please enter YES or NO to decide whether you want to use pepstats method to get it: \n")
        if pepReply == "YES":
            ...
            print("Done\n The output will be stored in the proSeqProperties.txt in the data directory. \n")
    else:
        print("\nSummarise the protein properties by pepstats method...")
        os.system("pepstats -sequence ./data/proSeq.fa --outfile ./data/proSeqProperties.txt")
        print("Done\n The output will be stored in the proSeqProperties.txt in the data directory. \n")

    # Get the sequence quantity
    ...
    # Warnings when the sequences is more than 1000
    if proSeqCount > 1000:
        if vbo:
            ...
            if proSeqCountReply == "NO":
                exit(
                    "\nAdvice: Maybe select particular species or protein IDs will help to reduce the quantity of sequences\n")
        else:
    ...
    # Find PEST motifs to check proteolytic cleavage sites
    def hth():
        if selected:
