...
def protree(proFamily, taxGroup, spOrId, proSelection, vbo):
    ...
    if vbo:
        pepReply = input("Do you want to get the protein property information of collected sequences generated by pepstats method? \n" +
    ...
    print("Basic Information of collected sequences: \n")
    print("Species Quantity: " + str(proSeqCount) + "\n" +
